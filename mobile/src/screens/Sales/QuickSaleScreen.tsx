...
const styles = StyleSheet.create({
  ...
  stepBar: { flexDirection: "row", gap: 6, marginBottom: 12 },
  stepChip: {
    alignItems: "center",
  ...
  scanActions: { flexDirection: "row", gap: 10, marginTop: 10 },
  permissionBox: { backgroundColor: ios.card, borderRadius: 18, padding: 16 },
  sectionTitle: { color: ios.label, fontFamily: fonts.semibold, fontSize: 16, marginBottom: 10 },
  secondaryButton: {
    alignItems: "center",
  ...
  heroAmount: { color: "#FFFFFF", fontFamily: fonts.bold, fontSize: 40, letterSpacing: -1, marginTop: 2 },
  fieldLabel: { color: ios.secondary, fontFamily: fonts.medium, fontSize: 13, marginBottom: 8 },
  ...
  qrHint: { color: ios.secondary, fontFamily: fonts.medium, fontSize: 12, marginTop: 14 },
  cancelButton: { alignItems: "center", height: 44, justifyContent: "center" },
  cancelText: { color: ios.secondary, fontFamily: fonts.semibold },
  invoice: {
    backgroundColor: ios.card,
    borderRadius: 18,
    marginBottom: 12,
  ...
  invoiceShop: { color: ios.label, fontFamily: fonts.bold, fontSize: 22 },
  ...
  invoiceInfo: { flex: 1, paddingRight: 10 },
  invoiceName: { color: ios.label, fontFamily: fonts.semibold, fontSize: 14 },
  invoiceAmount: { color: ios.label, fontFamily: fonts.bold },
  invoiceTotal: {
    borderTopColor: ios.separator,
    borderTopWidth: StyleSheet.hairlineWidth,
    marginTop: 4,
  ...
  invoiceTotalValue: { color: ios.label, fontFamily: fonts.bold, fontSize: 28, marginTop: 2 },
  newSaleButton: { alignItems: "center", height: 48, justifyContent: "center", marginTop: 8 },
  newSaleText: { color: ios.blue, fontFamily: fonts.bold },
});
