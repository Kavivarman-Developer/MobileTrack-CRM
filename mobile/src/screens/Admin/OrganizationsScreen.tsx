...
const styles = StyleSheet.create({
  ...
  headerActions: { alignItems: "center", flexDirection: "row", gap: 8, marginTop: 4 },
  bannerCard: {
    alignItems: "center",
    backgroundColor: ios.card,
    borderRadius: 16,
  ...
  fieldLabel: { color: ios.secondary, fontFamily: fonts.semibold, fontSize: 13, fontWeight: "600", marginBottom: 6, marginTop: 8 },
  segment: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginBottom: spacing.sm },
  segmentButton: { backgroundColor: ios.fill, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 10 },
  ...
  stat: { backgroundColor: ios.fill, borderRadius: 10, flex: 1, padding: 10 },
