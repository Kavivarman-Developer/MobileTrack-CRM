...
const styles = StyleSheet.create({
  ...
  content: { alignSelf: "center", maxWidth: 430, paddingBottom: 110, paddingHorizontal: 16, width: "100%" },

  header: { alignItems: "flex-start", flexDirection: "row", marginBottom: 20, marginTop: 6 },
  headerCopy: { flex: 1, justifyContent: "center", marginHorizontal: 12, minHeight: 42, minWidth: 0, paddingTop: 1 },
  greeting: { color: ios.secondary, fontFamily: fonts.medium, fontSize: 13, lineHeight: 16 },
  ownerName: { color: ios.label, fontFamily: fonts.bold, fontSize: 24, letterSpacing: -0.4, lineHeight: 28, marginTop: 2 },
  shopCaption: { color: ios.secondary, fontFamily: fonts.regular, fontSize: 12, lineHeight: 16, marginTop: 2 },
  menuBtn: {
    alignItems: "center",
  ...
  profileText: { color: "#FFFFFF", fontFamily: fonts.semibold, fontSize: 16, lineHeight: 20, textAlign: "center" },
  ...
  errorCopy: { flex: 1 },
  errorTitle: { color: ios.label, fontFamily: fonts.semibold, fontSize: 16 },
  errorText: { color: ios.secondary, fontFamily: fonts.regular, fontSize: 13, marginTop: 2 },
  alertCard: {
    alignItems: "center",
    backgroundColor: "#FF3B3014",
    borderRadius: 14,
  ...
  alertText: { color: ios.label, flex: 1, fontFamily: fonts.medium, fontSize: 14 },
  ...
  moneyOverline: { color: "rgba(255,255,255,0.62)", fontFamily: fonts.medium, fontSize: 13 },
  moneyAmount: { color: "#FFFFFF", fontFamily: fonts.bold, fontSize: 40, letterSpacing: -1, lineHeight: 46, marginTop: 4 },
  moneyPills: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: 12 },
  moneyPill: {
  ...
  segment: { backgroundColor: "rgba(255,255,255,0.12)", borderRadius: 11, flexDirection: "row", marginTop: 16, padding: 3 },
  segmentItem: { alignItems: "center", borderRadius: 9, flex: 1, justifyContent: "center", minHeight: 32 },
  segmentItemOn: { backgroundColor: "#FFFFFF" },
  segmentText: { color: "rgba(255,255,255,0.82)", fontFamily: fonts.medium, fontSize: 13 },
  ...
  moneyCtaText: { color: ios.dark, fontFamily: fonts.semibold, fontSize: 15 },
  ...
  promoTitle: { color: ios.label, fontFamily: fonts.semibold, fontSize: 15, letterSpacing: -0.2 },
  promoMessage: { color: ios.secondary, fontFamily: fonts.regular, fontSize: 13, lineHeight: 18, marginTop: 2 },
  promoCta: { fontFamily: fonts.semibold, fontSize: 13, marginTop: 6 },
  ...
  sectionHead: { alignItems: "center", flexDirection: "row", marginBottom: 8, marginLeft: 4, marginTop: 22 },
  sectionLabelInline: { color: ios.secondary, fontFamily: fonts.regular, fontSize: 13, letterSpacing: -0.08 },
  viewAllBtn: { alignItems: "center", flexDirection: "row", gap: 2, marginLeft: "auto" },
  viewAllText: { color: ios.blue, fontFamily: fonts.semibold, fontSize: 13 },
  stockCount: {
  ...
  stockIcon: { alignItems: "center", borderRadius: 14, height: 40, justifyContent: "center", marginTop: 2, width: 40 },
  stockBody: { flex: 1, marginLeft: 12, minWidth: 0 },
  stockImageWrap: {
  ...
  stockQtyText: { color: "#FFFFFF", fontFamily: fonts.semibold, fontSize: 11 },
  stockQtyTextOut: { color: "#FFFFFF" },
  stockName: { color: ios.label, fontFamily: fonts.semibold, fontSize: 12, letterSpacing: -0.2, lineHeight: 15, minHeight: 30 },
  stockSku: { color: ios.secondary, fontFamily: fonts.regular, fontSize: 10, marginTop: 2 },
  stockBarTrack: { backgroundColor: ios.fill, borderRadius: 999, height: 4, marginTop: 8, overflow: "hidden", width: "100%" },
  stockBarFill: { backgroundColor: ios.orange, borderRadius: 999, height: 4 },
  stockBarOut: { backgroundColor: ios.red },
  stockLink: { color: ios.blue, fontFamily: fonts.semibold, fontSize: 11, marginTop: 6 },
  ...
  actionLabel: { color: ios.label, fontFamily: fonts.semibold, fontSize: 15, marginTop: 10 },
  ...
  statIcon: { alignItems: "center", borderRadius: 8, height: 24, justifyContent: "center", width: 24 },
  statLabel: { color: ios.secondary, fontFamily: fonts.regular, fontSize: 13, marginTop: 10 },
  statValue: { color: ios.label, fontFamily: fonts.bold, fontSize: 20, letterSpacing: -0.4, marginTop: 2 },
});
