...
const styles = StyleSheet.create({
  ...
  filters: { flexDirection: "row", gap: spacing.sm, marginBottom: spacing.xxs, marginTop: 11 },
  filterHalf: { flex: 1 },
  ...
  metaRow: { alignItems: "center", flexDirection: "row", flexWrap: "wrap", gap: spacing.xs, marginTop: spacing.xxs },
